...
export const USERS: User[] = [
  ...
  {
    id: "u2", name: "Priya Mehta", username: "@priya_m", avatar: avatar("Priya Mehta"), bio: "Run first, think later. Hiker on rest days.", city: "Bhopal",
    sportsPlayed: ["Running", "Badminton", "Hiking"], rating: 4.9, totalGames: 31, showUpRate: 100, followers: 312, following: 67, isFollowing: true,
  ...
  },
  {
    ...
    sportsPlayed: ["Party", "Cricket", "Gaming"], rating: 4.4, totalGames: 45, showUpRate: 91, followers: 378, following: 210, isFollowing: false,
  ...
  },
  {
    ...
    sportsPlayed: ["Travel", "Cycling", "Running"], rating: 4.9, totalGames: 34, showUpRate: 100, followers: 612, following: 89, isFollowing: false,
  ...
  {
    id: "u12", name: "Ishita Verma", username: "@ishita_v", avatar: avatar("Ishita Verma"), bio: "Travel addict. Bhopal born, globally curious.", city: "Bhopal",
    sportsPlayed: ["Travel", "Running", "Cycling"], rating: 4.6, totalGames: 27, showUpRate: 96, followers: 334, following: 145, isFollowing: true,
    badges: [{ icon: "🌍", label: "Explorer" }], karma: 920,
  },
  {
...
export const NOTIFICATIONS: Notification[] = [
  ...
  { id: "n6", type: "new_pool", text: "Ishita raised a new pool: Cycling to Bhojpur Temple", timestamp: "3h ago", read: true, actionLabel: "Join", linkTo: "/pool/p7" },
  ...
  { id: "n12", type: "reminder", text: "Cycling to Bhojpur Temple is tomorrow at 6:30 AM", timestamp: "3 days ago", read: true, linkTo: "/pool/p7" },
  { id: "n13", type: "new_pool", text: "Karan raised a new pool: Rooftop party Friday", timestamp: "4 days ago", read: true, linkTo: "/pool/p6" },
  { id: "n14", type: "payment", text: "₹150 received from Arjun for Cricket pool", timestamp: "5 days ago", read: true },
...
export const REVIEWS = [
  ...
  { id: "r5", userId: "u12", userName: "Ishita Verma", userAvatar: avatar("Ishita Verma"), rating: 5, text: "Amazing host! The cycling trip was so well planned.", activity: "Cycling", date: "2 months ago" },
];
